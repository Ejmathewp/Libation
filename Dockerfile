...
RUN dotnet publish -c Release -o /Source/bin/Publish/Linux-chardonnay /Source/LibationCli/LibationCli.csproj -r linux-arm64 -p:PublishProfile=LibationCli/Properties/PublishProfiles/LinuxProfile.pubxml
